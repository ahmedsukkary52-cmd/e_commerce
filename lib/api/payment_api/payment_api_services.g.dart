...
class _PaymentApiServices implements PaymentApiServices {
  _PaymentApiServices(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<AuthTokenResponse> getAuthToken(
      AuthTokenRequest authTokenRequest,) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(authTokenRequest.toJson());
  ...
  Future<PaymentKeyResponse> getPaymentKey(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(paymentKeyRequest.toJson());
  ...
  @override
  Future<KioskPayResponse> payWithKiosk(KioskPayRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<KioskPayResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
        _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late KioskPayResponse _value;
    try {
      _value = KioskPayResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
